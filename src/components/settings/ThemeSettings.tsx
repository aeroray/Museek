  ...
  return (
    <div className="space-y-6">
      <div className="space-y-3">
        <SettingHeader title={t("theme.modeTitle")} desc={t("theme.modeDesc")} />
      ...
      <div className="space-y-3">
        <SettingHeader title={t("lang.title")} desc={t("lang.desc")} />
        <div className="flex gap-2">
          {LANGS.map((l) => (
            <Button
              key={l.id}
      ...
      <div className="space-y-3">
        <SettingHeader title={t("theme.paletteTitle")} desc={t("theme.paletteDesc")} />
