"use strict";
import { WASM_BINARY } from "./afp.wasm.js";
...
let AudioFingerprintRuntime = () => {
  ...
  function it(t) {
    var e = ot[t];
    return (
      e || (t >= ot.length && (ot.length = t + 1), (ot[t] = e = L.get(t))),
      e
    );
  }
      ...
      ((function () {
        ...
        function getBinaryPromise(e) {
          return (function () {
            ...
            .then(e, function (t) {
              (g("failed to asynchronously prepare wasm: " + t, Q), abort(t));
            });
        }
        if (
          (J++,
          ...
          try {
            ...
            return (
              g("Module.instantiateWasm callback failed with error: " + t),
              !1
            );
          }
        w ||
