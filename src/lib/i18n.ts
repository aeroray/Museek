...
const dict: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "about.updateDescMirror": "有新版本 v{version} 可用。当前网络无法完成应用内安装，请使用镜像下载或打开 Releases。",
    "about.download": "前往下载",
    "about.installNow": "立即更新",
    "about.mirrorDownload": "镜像下载",
    "about.tryAnotherMirror": "换一个镜像",
    "about.later": "稍后",
    "about.updating": "正在安装…",
    "about.updatingPercent": "正在下载… {percent}%",
    "about.updateFailed": "更新失败：{msg}",
    "about.openReleases": "打开 Releases",
    ...
    "update.cannotInstall": "当前无法应用内安装，请稍后重试检查更新或打开 Releases",
  ...
  en: {
    ...
    "about.updateDescMirror": "Version v{version} is available. In-app install is unavailable; use the mirror download or open Releases instead.",
    "about.download": "Download",
    "about.installNow": "Update now",
    "about.mirrorDownload": "Mirror download",
    "about.tryAnotherMirror": "Try another mirror",
    "about.later": "Later",
    ...
    "update.downloadPercent": "{percent}%",
    "update.cannotInstall": "In-app install is unavailable. Retry check later or open Releases.",
