...
const dict: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "download.noLocationDesc": "下载歌曲前，请先在「设置 → 播放与下载」中选择文件的保存位置。",
  ...
  en: {
    ...
    "download.noLocationDesc": "Before downloading, choose where files are saved in Settings → Playback & Download.",
