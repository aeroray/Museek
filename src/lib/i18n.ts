...
const dict: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "local.empty": "还没有本地音乐",
    "local.emptyHint": "点右上角导入，文件不会被复制",
  ...
  en: {
    ...
    "local.emptyHint": "Import from the top right — files stay in place",
    ...
    "sync.note": "Syncs settings and favorites only — not downloads or cache.",
