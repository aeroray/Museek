...
const dict: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "player.goImport": "去导入",
    "lyrics.fontIncrease": "增大字体（{shortcut}）",
    "lyrics.fontDecrease": "减小字体（{shortcut}）",
  ...
  en: {
    ...
    "lyrics.fontIncrease": "Increase font size ({shortcut})",
    "lyrics.fontDecrease": "Decrease font size ({shortcut})",
